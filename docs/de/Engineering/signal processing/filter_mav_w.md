...
| | FILTER_MAV_W ist ein Filter mit gleitendem Mittelwert. Beim Filter mit gleitendem Mittelwert (auch MovingAverage Filter genannt) wird der Mittelwert von N aufeinander folgenden Messwerten als Mittelwert ausgegeben. |
| **Y** | = (X0 + X1 + … + Xn-1) / N |
