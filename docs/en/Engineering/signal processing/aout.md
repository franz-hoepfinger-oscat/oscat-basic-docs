...
Examples : A 12-bit D/A converter without a sign and output range from 0-10 is defined as follows: Bits = 12, Sign = 255, LOW = 0, HIGH = 10 A 14-bit D/A converter with 14 bits with sign and output range -10 - +10 is defined as: Bits = 14,  Sign = 14, Low = 0, HIGH = +10. A 24-bit D/A converter without a sign and output range from -10 - +10 is defined as follows: Bits = 24, Sign = 255, LOW = -10, HIGH = +10
